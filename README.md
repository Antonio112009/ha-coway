...
You do not need to enable anything extra in Home Assistant to make diagnostics available. The Diagnostics integration is built in and enabled by default.
